...
export default function EliminazioniPage() {
  return (
    <div className="flex flex-1 flex-col items-center gap-6 bg-ink-50 px-6 py-16 pb-24 dark:bg-ink-950">
      <div className="flex w-full max-w-2xl flex-col gap-1">
        ...
        <h1 className="text-xl font-semibold text-ink-950 dark:text-ink-50">Eliminazioni</h1>
        <p className="text-sm text-ink-500 dark:text-ink-400">
          Cosa hai cancellato di recente — spese, entrate, trasferimenti, ricorrenze, categorie.
        </p>
      </div>
      <DeletionLogClient />
